		...
		<>
			<div className="flex w-[100vw] justify-center h-[100vh] items-center">
				<div className="flex w-[100vw] xl:w-[1280px]">
					<div className="flex-auto transition-colors duration-[400ms] color-fondo h-[100vh] xl-h:h-[700px] ">
						<div className="absolute flex-auto bg-stone-800 w-[calc(100vw-240px)] h-[740px] ml-[120px] xl:w-[1040px] mt-[-20px]"></div>
