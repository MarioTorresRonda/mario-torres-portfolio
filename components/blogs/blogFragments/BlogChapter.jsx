...
const textLevel = {
    1: "text-2xl  md:text-3xl font-semibold text-stone-300",
    2: "text-xl md:text-2xl font-semibold text-stone-400",
    3: "text-xl md:text-xl font-semibold text-stone-400",
    4: "text-lg md:text-lg font-semibold text-stone-400"
}
