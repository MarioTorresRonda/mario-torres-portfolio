...
export default function BlogResumeItemImage() {
    ...
    return (<>
        <div className={ ( !isShow ? "-translate-y-80" : "" ) + " transition-all flex justify-center h-[250px]" } onClick={OnClickImage} >
            <ClientImage height={250} className=" mt-3 mb-5 scale-100 hover:scale-110 transition-all" src={ menu.oldBlog.image } alt={["mainPage","blogs","imageAlt"]}/>
        </div>
