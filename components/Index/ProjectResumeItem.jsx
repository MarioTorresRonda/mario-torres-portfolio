...
export default function ProjectResumeItem( {name, description, isOdd} ) {
    ...
    <div className="flex relative mb-2">
        <div className={`absolute top-0 bottom-0 w-[100px] color-fondo clip-highlight ${isOdd ? "" : colorInvertido }`}></div>
        <div className="px-5 py-2 hover:bg-stone-700 transition ease-linear duration-300">
