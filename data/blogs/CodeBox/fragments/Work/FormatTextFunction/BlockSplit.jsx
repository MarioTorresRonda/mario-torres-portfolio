...
export default function BlockSplit(files, getText) {
	const files1 = [...files];
	...
	return (
		<BlogChapter code={["codeBox", "work", "implementation", "formatTextFunction", "blockSplit", "title"]}>
			...
			<BlogGetTextChildren
				prop="list"
				code={["codeBox", "work", "implementation", "formatTextFunction", "blockSplit"]}
				codeArray={["foot7_1", "foot7_2"]}
				func={returnListAsPs}
			>
				<BlogList elementClass="flex flex-col gap-2 w-full" char="-" />
			</BlogGetTextChildren>
